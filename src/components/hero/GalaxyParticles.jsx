...
const FBOParticles = () => {
  ...
  const uvs = useMemo(() => new Float32Array([
    0, 0,  // bottom-left
    1, 0,  // bottom-right
    1, 1,  // top-right
    0, 0,  // bottom-left
  ...
  return (
    <>
      {createPortal(
        <mesh>
          <simulationMaterial ref={simulationMaterialRef} args={[size, simulationVertexShader, simulationFragmentShader]} />
          <bufferGeometry>
            <bufferAttribute
...
export const GalaxyScene = () => {
  return (
    <Canvas camera={{ position: [1.5, 1.5, 2.5], fov: 75 }} className="w-full h-full">
