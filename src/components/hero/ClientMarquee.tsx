...
export const ClientMarquee = ({ clientLogos }: { clientLogos: { src: string; alt: string }[] }) => {
  ...
  return (
    <div className="relative w-full bg-[#00042A] overflow-hidden border-t border-white/[0.04]">
      {/* Label */}
      <motion.div
      ...
      >
        <span className="text-xs tracking-[0.25em] uppercase text-white/25 font-medium">
      ...
      <div className="relative h-[70px] flex items-center overflow-hidden">
        {/* Edge fades */}
        <div className="absolute left-0 top-0 bottom-0 w-24 bg-gradient-to-r from-[#00042A] to-transparent z-10 pointer-events-none" />
        <div className="absolute right-0 top-0 bottom-0 w-24 bg-gradient-to-l from-[#00042A] to-transparent z-10 pointer-events-none" />
